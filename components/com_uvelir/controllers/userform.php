...
class UvelirControllerUserform extends JControllerForm
{
    ...
    public function submit()
	{
            ...
            if ($model->createItem($data)) 
            {
                ...
                $url = $mainframe->getUserState('com_uvelir.old_uri',NULL);
                $mainframe->setUserState('com_uvelir.old_uri',NULL);
                if (isset($url))
                {
