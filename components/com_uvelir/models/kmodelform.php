...
class ModelKModelform extends JModelForm
{
	 ...
	 */
	protected $model_name = 'uvelir';
	/**
	 * @var string table name
	 */
	protected $table_name = 'uvelir';
	/**
	...
	{
            // Get the form.
            $form = $this->loadForm('com_uvelir.'.$this->model_name, $this->model_name, array('control' => 'jform', 'load_data' => true));
            if (empty($form)) {
                    return false;
            }
            return $form;
	...
	public function getTable($type = '', $prefix = 'UvelirTable', $config = array()) 
	{
        ...
        public function getItem($id = null)
        {
            if(!isset($id))
            {
                $id = JFactory::getApplication()->getUserState('com_uvelir.'.$this->table_name.'_id',0,0);           
            }
...
//                var_dump($this->_db->getErrorMsg());exit;
	...
	protected function loadFormData() 
	{
        ...
        public function getTablelist()
        {
            ...
            {
                $table = $this->getTable($table_alias,'UvelirTable');
