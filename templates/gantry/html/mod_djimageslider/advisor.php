...
<div id="djslider-loader<?php echo $mid; ?>" class="djslider-loader">
    <div id="djslider<?php echo $mid; ?>" class="djslider">
          		...
          		<?php foreach ($slides as $slide) { ?>
          			<li>
          				<?php if($slide->image) { ?>
							...
							<?php } ?>
								<img src="<?php echo thumb($slide->image, 'adaptiveResize',90,96); ?>" alt="<?php echo $slide->alt; ?>" />
							<?php if (($slide->link && $params->get('link_image',1)==1) || $params->get('link_image',1)==2) { ?>
								</a>
							<?php } ?>
						<?php } ?>
        ...
        <div id="navigation<?php echo $mid; ?>" class="navigation-container">
        	...
        	<span id="prev<?php echo $mid; ?>" class="prev-button" alt="<?php echo JText::_('MOD_DJIMAGESLIDER_PREVIOUS'); ?>" ></span>
			<span id="next<?php echo $mid; ?>" class="next-button" alt="<?php echo JText::_('MOD_DJIMAGESLIDER_NEXT'); ?>" ></span>
			<?php } ?>
