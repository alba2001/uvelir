 ...
 * OrderList Model
 */
class UvelirModelOrders extends UvelirModelKModelList
{
	/**
	...
	protected function getListQuery()
	{
            ...
            $query->from('`#__uvelir_orders` AS a');
            ...
            if (!empty($search)) 
            {
                ...
                else 
                {
                    ...
                    $query->leftJoin('#__uvelir_users AS b ON a.userid = b.id');
...
//                    var_dump((string)$query);
	...
	public function getOrderStatusOptions()
	{
            ...
            $query->select('*');
            $query->from('#__uvelir_order_statuses');
