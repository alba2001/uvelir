 ...
 * User View
 */
class UvelirViewUser extends JView
{
	/**
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title($isNew ? JText::_('COM_UVELIR_MANAGER_USER_NEW') : JText::_('COM_UVELIR_MANAGER_USER_EDIT'), 'user');
	...
	protected function setDocument() 
	{
		...
		$document->setTitle($isNew ? JText::_('COM_UVELIR_UVELIR_CREATING') : JText::_('COM_UVELIR_UVELIR_EDITING'));
		$document->addScript(JURI::root() . $this->script);
		$document->addScript(JURI::root() . "/administrator/components/com_uvelir/views/user/submitbutton.js");
