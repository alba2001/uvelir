...
class UvelirViewOrder extends JView
{
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title($isNew ? JText::_('COM_UVELIR_MANAGER_ORDER_NEW') : JText::_('COM_UVELIR_MANAGER_ORDER_EDIT'), 'order');
	...
	protected function setDocument() 
	{
		...
		$document->setTitle($isNew ? JText::_('COM_UVELIR_MANAGER_ORDER_NEW') : JText::_('COM_UVELIR_MANAGER_ORDER_EDIT'));
		$document->addScript(JURI::root() . $this->script);
		$document->addScript(JURI::root() . "/administrator/components/com_uvelir/views/order/submitbutton.js");
//                $document->addScript(JURI::base().'components/com_uvelir/assets/scripts/jquery.maskedinput-1.3.min.js');
		JText::script('COM_UVELIR_UVELIR_ERROR_UNACCEPTABLE');
	}
}
