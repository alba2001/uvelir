...
<form action="<?php echo JRoute::_('index.php?option=com_uvelir&view=products'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_UVELIR_PRODUCTS_NAME', 'a.name', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_UVELIR_PRODUCTS_CREATED_BY', 'a.created_by', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_UVELIR_PRODUCTS_CITY_ID', 'a.city_id', $listDirn, $listOrder); ?>
				</th>
		...
		<?php foreach ($this->items as $i => $item) :
			...
			$canCreate	= $user->authorise('core.create',		'com_uvelir');
			$canEdit	= $user->authorise('core.edit',			'com_uvelir');
			$canCheckin	= $user->authorise('core.manage',		'com_uvelir');
			$canChange	= $user->authorise('core.edit.state',	'com_uvelir');
			?>
