 ...
 * city Table class
 */
class UvelirTableKtable extends JTable {
...
//        if(!JFactory::getUser()->authorise('core.edit.state','com_uvelir.city.'.$array['id']) && $array['state'] == 1){
//                $array['state'] = 0;
//        }
    ...
    public function check() 
    {
        ...
        if(!isset($this->alias) OR empty($this->alias)) 
        {
            $this->alias = '';
            if(isset($this->title))
            {
    ...
    */
    protected function _getAssetName() {
        $k = $this->_tbl_key;
        return 'com_uvelir.'.$this->asset_name.'.' . (int) $this->$k;
    }
    ...
    */
    protected function _getAssetParentId($table = null, $id = null){
        ...
        $assetParent->loadByName('com_uvelir');
